...
<Steps>
  <Step title="Go to GitHub Repository">
    Navigate to: `https://github.com/yourusername/whatsapp-team-inbox`
  </Step>
...
- **Community Support**: [GitHub Discussions](https://github.com/yourusername/whatsapp-team-inbox/discussions)
